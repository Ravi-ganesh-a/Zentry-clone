...
const Hero = () => {
    ...
    useGSAP( () =>{
        ...
        gsap.set('#video-frame',{
            clipPath:'polygon(9% 0, 78% 0, 90% 78%, 0 97%)',
        ...
        <div id="video-frame" className="relative h-dvh w-screen z-10 overflow-hidden rounded-lg bg-blue-75">
                ...
                <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
                    ...
                    <div onClick={handleMiniVdClick} className="origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100"> 
                        <video
                         ...
                         muted
                         id="current-video"
                         className="size-64 origin-center scale-120 object-center object-cover"//
            ...
            <div className="absolute left-0 top-0 z-40 size-full">
                <div className="mt-14 px-5 sm:px-10">
                    <h1 className="special-font hero-heading text-blue-100">redif<b>n</b>e</h1>
